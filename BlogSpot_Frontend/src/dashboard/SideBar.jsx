...
//   console.log("Damnn",profile)

//   const handleComponents = (value) => {
//     setComponent(value);
//     setShow(false); // Close the sidebar when an item is clicked (on mobile)
//   };
...
//       <div 
//           //  add fix
//         className={`w-60 h-full shadow-lg fixed  top-0 left-0 bg-gray-50 transition-transform duration-300 transform sm:translate-x-0 ${
